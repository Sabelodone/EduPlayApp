...
class User(db.Model):
    ...
    challenge_participations = db.relationship('ChallengeParticipation', backref='user', cascade='all, delete-orphan')
...
class UserAchievement(db.Model):
    ...
    achievement_data = db.Column(db.Text)  # JSON string
...
# ADD THIS TO YOUR app/models.py
